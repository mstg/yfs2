// Based on https://github.com/rpm-software-management/rpm/blob/9f62aba3bd26eea51d411f0d17ee4dadbf2fd873/rpmio/digest_openssl.c
                           ...
                           uint8_t *hash, size_t hashlen, int hash_algo)
{
    ...
    if (EVP_DigestVerifyInit(md_ctx, NULL, NULL, NULL, key->evp_pkey) != 1)
	goto done;
