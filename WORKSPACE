...
#     urls = ["https://github.com/google/brotli/archive/v1.1.0.tar.gz"],
# )
#
# # ------------------------------------------------------------------------------
# # cpprestsdk
...
#     build_file = "//third_party:BUILD.cpprestsdk",
#     sha256 = "67938e690f7a6843fb179cc32b3afce16b13de9efd6d84da085bd46cb23f77ad",
#     strip_prefix = "cpprestsdk-9c654889efb6f5bda69fe8f52b3f7d3d3fb56cd8",
#     urls = ["https://github.com/microsoft/cpprestsdk/archive/9c654889efb6f5bda69fe8f52b3f7d3d3fb56cd8.tar.gz"],
# )
#
# # ------------------------------------------------------------------------------
# # etcd-cpp-apiv3
# # ------------------------------------------------------------------------------
# http_archive(
#     name = "com_github_nokia_etcd_cpp_apiv3",
#     build_file = "//third_party:BUILD.etcd",
#     # Let's just use sed to replace '#include "proto' with '#include "third_party/etcd_proto'
#     # Replace that in all .cpp files so single sed command is enough
#     patch_cmds = [
#         "sed -i .bak 's/#include \"proto/#include \"third_party\\/etcd_proto/g' $(find . -name '*.cpp' -or -name '*.hpp')",
#     ],
#     sha256 = "7f334e9a219a65cfcefd7a526d8d9ab613f77d75879f82645c9dc47f17b0e8c8",
#     strip_prefix = "etcd-cpp-apiv3-0.15.2",
#     urls = ["https://github.com/etcd-cpp-apiv3/etcd-cpp-apiv3/archive/v0.15.2.tar.gz"],
# )
